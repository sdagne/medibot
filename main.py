...
<div style="text-align: center; padding: 2rem 0;">
    <h1 style="color: #ff4b4b; font-size: 3rem; margin-bottom: 0.5rem;">Improved Medibot</h1>
        ...
        if st.session_state.vectorstore is not None and st.session_state.chat_model is not None:
            with st.chat_message("assistant"):
                ...
                with st.spinner("Searching documents..."):
                    ...
                    system_prompt = f"""You are Medibot, an intelligent medical document assistant with expertise in medical analysis. 
